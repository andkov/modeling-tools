...
d1 %>% 
  ...
  # scale_fill_manual(values = c(abcol["sky"], abcol["sunset"]))+
  labs(
    x = NULL
    ,y = NULL
    ,title = "Number of clients selected into the FIESTA research population (First Income Support in 2014-2019 FY + known eranings before and after IS)"
