...
# verify
nia_null %>% filter(intervention == "career_planning")
...
g1 <- 
  ...
  scale_color_manual(values = c("TRUE"=abcol[["sunset"]], "FALSE"=abcol[["sky"]]))+
  labs(
    ...
    ,x = "Year relative to spell of Income Support"
    ,color = "Intervention\npresent"
  ) 
g1 %>% quick_save("main-effect",w=16,h=9)
```
