...
nia_full %>% 
  ...
  mutate(y_hat = y_hat/1000) %>% 
  {
    ...
    # ggrepel::geom_label_repel(aes(label = scales::comma(y_hat, accuracy = .1)))+
    ...
    scale_color_manual(values = c("TRUE"="navyblue","FALSE"="grey40"))+
